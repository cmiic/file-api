...
- **Exposing the scanner services to an untrusted network.** That is a deployment error, not a defect in this software.
- **Denial of service against an intentionally unauthenticated deployment**, or resource exhaustion when the documented reverse-proxy limits are absent.
